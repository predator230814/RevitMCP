...
public sealed class NamedPipeBridgeHost : IAsyncDisposable
{
    ...
    {
        return StartAsync(metadata, store, capability: null, query: null, getElements: null, describeParameters: null, getParameterValues: null, getMepTopology: null, cancellationToken);
    }
    ...
    public static Task<NamedPipeBridgeHost> StartAsync(
        ...
        CancellationToken cancellationToken)
    {
        return StartAsync(metadata, store, capability, query: null, getElements: null, describeParameters: null, getParameterValues: null, getMepTopology: null, cancellationToken);
    }
    ...
    public static Task<NamedPipeBridgeHost> StartAsync(
        ...
        CancellationToken cancellationToken)
    {
        return StartAsync(metadata, store, capability, query, getElements: null, describeParameters: null, getParameterValues: null, getMepTopology: null, cancellationToken);
    }
    ...
    public static Task<NamedPipeBridgeHost> StartAsync(
        ...
        CancellationToken cancellationToken)
    {
        return StartAsync(metadata, store, capability, query, getElements, describeParameters: null, getParameterValues: null, getMepTopology: null, cancellationToken);
    }
    ...
    public static Task<NamedPipeBridgeHost> StartAsync(
        ...
        CancellationToken cancellationToken)
    {
        return StartAsync(metadata, store, capability, query, getElements, describeParameters, getParameterValues: null, getMepTopology: null, cancellationToken);
    }
        ...
        IRevitGetMepTopologyService? getMepTopology = null)
    {
            ...
            && getMepTopology is not null)
        {
            ...
            && getParameterValues is not null)
        {
            versions = BridgeProtocol.GetParameterValuesVersions;
        }
        ...
        {
            versions = BridgeProtocol.GetElementsVersions;
        }
        else if (capability is not null && query is not null)
        {
            versions = BridgeProtocol.QueryElementsVersions;
        }
        else if (capability is not null)
        {
