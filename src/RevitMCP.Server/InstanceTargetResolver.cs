...
internal static class InstanceTargetResolver
{
    ...
    public static TargetResolution ResolveForGetElements(IReadOnlyList<DiscoveredInstance> discovered, string? instanceId)
    {
    ...
    public static TargetResolution ResolveForGetParameterValues(IReadOnlyList<DiscoveredInstance> discovered, string? instanceId)
    {
