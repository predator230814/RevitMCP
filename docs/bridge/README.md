...
- `BRIDGE-0006-get-parameter-values-capability-rpc.md` — CAP-0005 typed-read RPC (`revit.get_parameter_values`) on bridge protocol version 6; v6 explicitly preserves the v2/v3/v4/v5 capability guarantees. Specified, not implemented.
