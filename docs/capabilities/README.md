...
- `CAP-0007-revit-preview-parameter-updates.md` — proposed preview of one bounded instance-parameter batch and an ephemeral `intent_ref`. No Revit model write. Not implemented.
