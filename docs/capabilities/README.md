...
- `CAP-0006-revit-get-mep-topology.md` — bounded physical MEP element-to-element topology from known seeds. Implemented through Contracts/Addin/typed Bridge. Typed Bridge live Revit validation is **PENDING**. The MCP tool is not implemented.
