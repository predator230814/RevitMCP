...
The read-only six-tool baseline and that compatibility evidence remain complete. The next architectural checkpoint is Proposed ADR-0008, the controlled-write safety model. No write capability exists yet. CAP-0007 is not accepted. `tools/list` remains exactly the six tools above.
...
- ADR-0008 is **Proposed**. It records the v1 controlled-write safety model. It does not accept CAP-0007 and does not authorize write production code.
...
- no write capability or write authorization; Proposed ADR-0008 is the safety model only, and CAP-0007 is not accepted;
...
2. The next architectural checkpoint is Proposed ADR-0008. It does not authorize write production code, CAP-0007, MRTR implementation, or an MCP SDK upgrade.
