...
- ADR-0008 is **Accepted**. It records the v1 controlled-write safety model. CAP-0007 is **Accepted** as a specification only and is not implemented. No Bridge or Server specification exists for it. CAP-0008/apply does not exist. No production write implementation is authorized.
...
- no production write implementation; ADR-0008 is **Accepted** as the safety model, and CAP-0007 is **Accepted** as a specification only;
...
2. ADR-0008 is **Accepted**. CAP-0007 is **Accepted** as a specification only. Neither authorizes write production code, a Bridge or Server specification, CAP-0008/apply, MRTR implementation, or an MCP SDK upgrade.
