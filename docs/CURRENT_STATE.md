...
The read-only six-tool baseline and that compatibility evidence remain complete. ADR-0008, the controlled-write safety model, is **Accepted**. CAP-0007, `revit_preview_parameter_updates`, is **Accepted** as a specification only and is not implemented. LIFECYCLE-0002, the ephemeral write-intent store, is **Accepted**. Its pure in-process store core is partially implemented. Document-close wiring, shutdown wiring, and CAP-0007 remain unimplemented. No Bridge or Server specification exists for CAP-0007. CAP-0008/apply does not exist. No production write implementation is authorized. `tools/list` remains exactly the six tools above.
...
- ADR-0008 is **Accepted**. It records the v1 controlled-write safety model. CAP-0007 is **Accepted** as a specification only and is not implemented. LIFECYCLE-0002 is **Accepted**. Its pure in-process store core is partially implemented. Document-close wiring, shutdown wiring, and CAP-0007 remain unimplemented. No Bridge or Server specification exists for CAP-0007. CAP-0008/apply does not exist. No production write implementation is authorized.
...
- Lifecycle specifications are recorded under `docs/lifecycle/`. LIFECYCLE-0001 is accepted. LIFECYCLE-0002 is **Accepted**. Its pure in-process intent-store core is partially implemented. Document-close wiring, shutdown wiring, and CAP-0007 remain unimplemented.
...
- no production write implementation; ADR-0008 is **Accepted** as the safety model, CAP-0007 is **Accepted** as a specification only and is not implemented, and LIFECYCLE-0002 is **Accepted** with only its pure in-process store core partially implemented;
...
2. ADR-0008 is **Accepted**. CAP-0007 is **Accepted** as a specification only and is not implemented. LIFECYCLE-0002 is **Accepted**. Its pure in-process store core is partially implemented. Document-close wiring, shutdown wiring, and CAP-0007 remain unimplemented. None of them authorizes a Revit model write, a Bridge or Server specification, CAP-0008/apply, MRTR implementation, or an MCP SDK upgrade.
...
The read-only baseline and live compatibility validation remain complete. `tools/list` remains exactly six tools. ADR-0008 is **Accepted**. CAP-0007, `revit_preview_parameter_updates`, is **Accepted** as a specification only and is not implemented. LIFECYCLE-0002 is **Accepted**. Its pure in-process store core is partially implemented. Document-close wiring, shutdown wiring, and CAP-0007 remain unimplemented. It does not authorize a Revit model write, a Bridge or Server specification, CAP-0008/apply, MRTR implementation, or an MCP SDK upgrade. Do not begin writes, APS, orchestrator, WebMCP, MCP Apps, UI, or dynamic tool scoping.
