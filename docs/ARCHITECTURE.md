...
- RevitMCP remains a specialized Revit capability service. Cloud Autodesk capabilities such as APS, ACC, and Forma belong behind separate logical MCP service boundaries when implemented (ADR-0007).
