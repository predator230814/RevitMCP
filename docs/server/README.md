...
- [SERVER-0005](SERVER-0005-stdio-get-parameter-values-tool.md) — CAP-0005 `revit_get_parameter_values`, bridge protocol-v6 capability gating, closed typed-value output variants, and preservation of CAP-0001..CAP-0004 on explicitly compatible v6 bridges. **Specification only / not yet implemented.** Current runtime MCP tools remain exactly 4.
