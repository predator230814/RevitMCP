...
- [SERVER-0004](SERVER-0004-stdio-describe-parameters-tool.md) — accepted spec for CAP-0004 `revit_describe_parameters`, bridge protocol-v5 capability gating, closed identity/data-type output variants, and preservation of CAP-0001/CAP-0002/CAP-0003 on explicitly compatible v5 bridges. Implementation is not started.
